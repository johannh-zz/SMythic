...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/SMythic.st', // list all sources in dependency order
                    'src/SMythic-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-smythic',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'SMythic', /* add other code-to-test packages here */
                    'SUnit',
                    'SMythic-Tests' /* add other test packages here */
                ],
